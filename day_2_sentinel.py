...
print("--- 🏗️ MARKET SENTINEL v2.0: LIVE EYES ---")

while True:
    ticker_symbol = input("\nEnter Ticker (e.g., TSLA, NVDA, BTC-USD) or 'exit': ").upper()
    ...
    try:
        ...
        if data.empty:
            print("❌ Error: Ticker not found or no data.")
            continue
        ...
        print(f"✅ Live Price: ${current_price:.2f} ({percentage_change:.2f}%)")
